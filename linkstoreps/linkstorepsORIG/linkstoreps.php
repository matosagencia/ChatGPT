...
class Linkstoreps extends Module
{
    ...
    {
        return array(
            'LINKSTOREPS_LIVE_MODE' => Configuration::get('LINKSTOREPS_LIVE_MODE', true),
            'LINKSTOREPS_ACCOUNT_EMAIL' => Configuration::get('LINKSTOREPS_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'LINKSTOREPS_ACCOUNT_PASSWORD' => Configuration::get('LINKSTOREPS_ACCOUNT_PASSWORD', null),
        );
    }
